...
<body>
	<div
		...
		<div style="margin: 0 auto; width: 580px; height: 600px;">
			...
			<div class="list_page">
				<a href="../ProductPagingSearch?pPage=${pPage}&sFlag=0">首页</a> <a href="../ProductPagingSearch?pPage=${pPage}&sFlag=1">上一页</a><a href="#">${pPage}/${intPage}</a><a href="../ProductPagingSearch?pPage=${pPage}&sFlag=2">下一页</a>
				<a href="../ProductPagingSearch?pPage=${pPage}&sFlag=3">尾页</a> <a href="UserSalePage.jsp">查看销售记录</a>
			</div>
