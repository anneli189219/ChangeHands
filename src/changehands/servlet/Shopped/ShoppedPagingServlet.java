...
/**
 * Servlet implementation class ShoppedPagingServlet
 */
@WebServlet("/ShoppedPagingServlet")
public class ShoppedPagingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShoppedPagingServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 0:
			...
			response.getWriter().println("<script>window.location='pages/UserShoppedPage.jsp'</script>");
			break;
		case 1:
			if (sPage!=1) {
				sPage--;
