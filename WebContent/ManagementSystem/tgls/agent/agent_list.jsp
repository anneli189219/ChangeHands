	...
	<body>
		<div class="cBody">
			...
			<div class="pages" style="margin-left:10px;">
				<button class="layui-btn layui-btn-xs" style="float: left;margin-left:5px;" onclick="window.location.href='/ChangeHands/UsersPaging?pages=upper'">上一页</button>
				<form class="layui-form" style="float: left;" action="/ChangeHands/UsersPaging" method="post">
				...
				<button style="margin-left:5px;" class="layui-btn layui-btn-xs" onclick="window.location.href='/ChangeHands/UsersPaging?pages=lower'">下一页</button>
			</div>
		</div>
	</body>
