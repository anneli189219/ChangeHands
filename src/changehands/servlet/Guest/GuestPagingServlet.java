...
/**
 * Servlet implementation class GuestPagingServlet
 */
@WebServlet("/GuestPagingServlet")
public class GuestPagingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GuestPagingServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case 0:
			...
			response.getWriter().println("<script>window.location='pages/UserGuestPage.jsp'</script>");
			break;
		case 1:
			if (nPage != 1) {
				nPage--;
