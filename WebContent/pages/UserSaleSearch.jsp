...
<body>
	<div
		...
		<div style="margin: 0 auto; width: 580px; height: 600px;">
			...
			<div class="list_page">
				<a href="../SalePagingSearch?aPage=${aPage}&sFlag=0">首页</a> <a href="../SalePagingSearch?aPage=${aPage}&sFlag=1">上一页</a><a href="#">${aPage}/${intPage}</a><a href="../SalePagingSearch?aPage=${aPage}&sFlag=2">下一页</a>
				<a href="../SalePagingSearch?aPage=${aPage}&sFlag=3">尾页</a>
			</div>
