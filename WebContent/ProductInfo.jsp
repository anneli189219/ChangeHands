	...
	<div class="page-container w">
		<div class="intro-wrap clear">
			<div class="p-img-wrap">
				...
				<form name="form_guest" action="GuestAddServlet.do?putID=${requestScope.productBean.ID}&pID=${requestScope.productBean.pID}&num=1" method="post" target="indexFrameName">
			...
			<div class="p-info-wrap">
				...
				<div class="info-item">
					...
					<a href="BabyAddServlet.do?pID=${requestScope.productBean.pID}" target="indexFrameName" class="btn cart-add">加入宝贝</a>
				</div>
			</div>
			<div class="p-info-wrap">
				<div class="info-item p-price-con">
					<p class="p-name">留言给商家<a class="guest_div_a" href="#" style="float: right;" onclick="document.form_guest.put_text.focus()">回复</a></p>
				</div>
				<div class="guest_div">
					<ul>
						<c:forEach var="guest" items="${requestScope.guestBookList}">
							<li><img src="imgs/${us:getUserPath(guest.setID)}"
								...
								<hr style="width: 100%; height: 1px; border: none; border-top: 1px solid #555555;margin-top: 20px;margin-bottom: 20px;" />
							</li>
						</c:forEach>
					</ul>
				</div>
