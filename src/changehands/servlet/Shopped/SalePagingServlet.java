...
/**
 * Servlet implementation class SalePagingServlet
 */
@WebServlet("/SalePagingServlet")
public class SalePagingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SalePagingServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ShoppedDaoImpl SaleDaoImpl = new ShoppedDaoImpl();

		List<Map<String, Object>> SaleList = SaleDaoImpl.getSaleSet(UserID);
		...
		case 0:
			...
			response.getWriter().println("<script>window.location='pages/UserSalePage.jsp'</script>");
			break;
		case 1:
			if (aPage!=1) {
				aPage--;
