...
GuestBookList = guestDaoImpl.getGuestSet(UserID);
...
<body>
	<div
		...
		<div style="margin: 0 auto; width: 580px; height: 600px;">
			...
			<table class="list_table_gridtable">
				...
				<c:forEach var="i" begin="${nPage*5-5}" end="${nPage*5-1}" items="${GuestBookList}">
					<tr>
						...
						<td><a href="UserGuestReply.jsp?setID=${i.setID}&getID=${i.getID}&pID=${i.pID}">回复</a> <a href="UserGuestUpdate.jsp?setID=${i.setID}&getID=${i.getID}&gID=${i.gID}">修改</a> 
			...
			<div class="list_page">
				<a href="../GuestPagingServlet?nPage=${nPage}&sFlag=0">首页</a> <a href="../GuestPagingServlet?nPage=${nPage}&sFlag=1">上一页</a><a href="#">${nPage}/${intPage}</a><a href="../GuestPagingServlet?nPage=${nPage}&sFlag=2">下一页</a>
				<a href="../GuestPagingServlet?nPage=${nPage}&sFlag=3">尾页</a>
			</div>
