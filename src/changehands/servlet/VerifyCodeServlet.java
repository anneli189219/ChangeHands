...
public class VerifyCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int width = 80;
		int height = 30;
		String data = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789abcdefghijklmnpqrstuvwxyz"; // 随机字符字典，其中0，o，1，I
		// 等难辨别的字符最好不要
		...
		/** 3 获得随机数据，并保存session */
		String CodeCacheData = builder.toString();
		request.getSession().setAttribute("CodeCacheData", CodeCacheData);
